...
@dataclass
class Config:
    out_dir: str = "dot_reconstruction/out"
    dot_spacing: int = 10
...
if __name__ == "__main__":
    IMAGE_PATHS = [
        # Example: update these when you know your actual paths
        # "dot_reconstruction/images/photo1.jpg",
    ]

    cfg = Config()

    if not IMAGE_PATHS:
        raise SystemExit("Set IMAGE_PATHS in dot_reconstruction/main.py")

    process_images(IMAGE_PATHS, cfg)
    print("Done. Outputs in dot_reconstruction/out")
